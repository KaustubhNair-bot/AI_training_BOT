...
## Key Takeaways
- Strict anti-leakage practices were followed throughout the pipeline.
- Cross-validation was used for reliable model selection.
- Business objectives guided metric selection and threshold tuning.
- The final model balances predictive performance with practical business impact.
